...
static const char* eww[] = { "google-chrome" };
...
static const Rule rules[] = {
    ...
    { "Android Emulator",      NULL,       NULL,       0,            1,           1,           -1 },
};
...
static const Key keys[] = {
    ...
    // { MODKEY,                           XK_Return,  spawn,            SHCMD("gnome-terminal")},

    // toggle stuff
    { MODKEY,                           XK_b,       togglebar,      {0} },
    { MODKEY|ControlMask,               XK_t,       spawn,          SHCMD("gnome-terminal") },
    { MODKEY|ShiftMask,                 XK_space,   togglefloating, {0} },
    { MODKEY,                           XK_f,       togglefullscr,  {0} },

    { MODKEY|ControlMask,               XK_w,       spawn,          {.v = (const char*[]){ BROWSER, NULL } } },
...
static const Button buttons[] = {
    ...
    { ClkStatusText,        0,              Button2,        spawn,          SHCMD("gnome-terminal") },
